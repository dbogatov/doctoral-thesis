...
\begin{sidewaystable}
	...
	\begin{tabular*}{\linewidth}{ !{\extracolsep\fill} l c c c c c } % chktex 26
		...
		\multirow{3}{*}{\cite{lewi-wu-ore}}			& \boldmath{} $\nicefrac{2n}{d}$ \unboldmath{} \textbf{(32)  PRP}	& \multirow{3}{*}{$\frac{n}{2d}$ (9) Hash}		& 																						& \multirow{3}{*}{Most-significant differing block}											\\
		...
		\multirow{3}{*}{\cite{cloz-ore}}			& $n$ (32) PRF													& \multirow{3}{*}{$\bm{n^2}$ \textbf{(1046) PPH}}	& \multirow{3}{*}{$n \cdot h$ (4096)}													& \multirow{3}{*}{\makecell{Equality pattern \\ of the most-significant \\ differing bit}}	\\
													& $n$ (32) PPH													&													&																						& 																							\\
													& 1 PRP															&													&																						& 																							\\
