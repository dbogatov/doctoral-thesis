...
\begin{sidewaystable}
	...
	\begin{tabular*}{\linewidth}{ !{\extracolsep\fill} l c c c c c } % chktex 26
		...
		CLWW~\cite{clww-ore}						& $n$ PRF 													& none										& $2n$																				& \textbf{Most-significant differing bit}								\\
		...
		\multirow{3}{*}{CLOZ~\cite{cloz-ore}}		& $n$ PRF													& \multirow{3}{*}{$\bm{n^2}$ \textbf{PPH}}	& \multirow{3}{*}{$n \cdot h$}														& Equality pattern														\\
