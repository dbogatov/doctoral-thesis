...
\thispagestyle{myheadings}
	...
	\section{Thesis structure}
		...
		In \cref{section:knn-snapshot}, we propose \kanon{} \cite{k-anon} --- a mechanism to answer similarity search (i.e., \acrlong{knn}) queries in a snapshot adversary setting using a type of property-preserving encryption similar to \acrshort{ope}.
		...
		\subsection{Works published or submitted during the Ph.D. program}
