...
\thispagestyle{myheadings}
	...
	\section{Model}
		...
		In this work, I consider \emph{an outsourced database system} model, a notion first introduction in \cite{outsourced-db-intro}, adapted from \cite{generic-attacks-kellaris} and \cite{epsolute}.
