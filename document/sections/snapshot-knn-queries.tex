...
\thispagestyle{myheadings}
	...
	\section{\texorpdfstring{\acrlong{dcpe}}{Distance Comparison Preserving Encryption}}
		...
		\subsection{\acrshort{dcpe} construction}
		...
		\subsection{\acrshort{dcpe} security}
		...
		\subsection{\acrshort{dcpe} implementation and benchmarks}
...
.
	...
	\section{\texorpdfstring{\acrshort{knn}}{kNN} search accuracy}
		...
		\subsection{Secure \acrshort{knn} protocol}
