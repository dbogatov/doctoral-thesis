...
\thispagestyle{myheadings}
	...
	\section{Range and point queries in a persistent model}\label{section:range-queries-persistent}
		...
		\subsection{Experimental evaluation}
			...
			To empirically verify the efficiency and practicality of our solution, we have implemented the construction and have run an extensive set of experiments.
			...
			Client \user{} and server \server{} are located in geographically different regions, with ping time between the regions \SI{12}{\milli\second} and effective bandwidth 
