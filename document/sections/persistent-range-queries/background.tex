\section{Background}\label{section:range-persistent:background}
	...
	\subsection{Differential Privacy and Sanitization}\label{section:range-persistent:building-blocks:dp}
	...
	\subsection{\acrlong{oram}}\label{section:range-persistent:building-blocks:oram}
