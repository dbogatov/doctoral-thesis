...
\thispagestyle{myheadings}
	...
	\section{Symmetric encryption}
		...
		Internally, the encryption consists of a keyed \acrfull{prp} (also known as a \emph{block cipher}), a \acrfull{prg} that is used to generate a (pseudo)random \acrfull{iv} and a block cipher \emph{mode of operation}.\footnote{% chktex 36
		...
		% TODO NIST for padding, AES, modes, PRGs.
